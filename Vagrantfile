...
Vagrant.configure("2") do |config|
  ...
  #  Install Node Exporter (host metrics for Prometheus - mirrors hermes-repo) 
...
ASKPASS
    ...
    # either way.
    docker compose build ${CORE_SERVICES} || echo "WARN: source build incomplete - the stack will run from the pulled images"
